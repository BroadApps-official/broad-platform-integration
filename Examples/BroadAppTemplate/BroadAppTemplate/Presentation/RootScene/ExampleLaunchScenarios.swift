        ...
        static let all = [
            ...
            ExampleLaunchArgumentGroup(
                ...
                arguments: [
                    ...
                    .init(
                        "-ru-provider-empty-products",
                        "Adapty вернул пустой массив продуктов: запросить RU-каталог.",
                        "Достаточно RU-региона телефона или Storefront; повторный тап не нужен."
                    ),
                    .init(
