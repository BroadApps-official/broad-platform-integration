...
> **Частично заменён 16 сентября 2026:**
> [ADR-0008](0008-adapty-provider-authority-for-ru-billing.md) разрешает explicit
> `ru_pay=true` из provider-managed Adapty payload. Ниже сохранён контекст прежнего
> решения. [ADR-0006](0006-ru-provider-outage-fallback.md) по-прежнему описывает
> отдельный резерв при недоступном провайдере.

- Статус: частично заменено ADR-0008
- Дата: 2026-08-22
