...
Кнопка `Clear recorded events` очищает только in-memory debug-историю.
Recorder удерживает максимум 256 событий и доступен только как fixture
destination; это не production storage.
