...
| Фаза | Результат | Проверка перед следующей фазой |
|---|---|---|
...
| 2. Docs | public editable site | build, link check, Pagefind search |
| 3. Extensions | standalone public package | module gate + sandbox + integration |
