...
<table>
  <tr>
    <td width="50%" valign="top">
      ...
      проверяем, что доступ открыт и показана актуальная версия.</p>
    </td>
    <td width="50%" valign="top">
      <h3>✨ Figma нет</h3>
      <p><strong>Это no-code-проект.</strong></p>
      <p>Интерфейс сначала подготавливается и согласовывается через Claude Design
      или Pencil. После согласования он становится источником для разработки.</p>
    </td>
  </tr>
</table>
...
|---|---|
| 🎨 **Источник интерфейса** | Figma или согласованный no-code-дизайн |
...
<table>
  <tr>
    <td align="center" width="20%">📎<br><strong>1. Материалы</strong><br><sub>Четыре строки</sub></td>
    <td align="center" width="20%">📋<br><strong>2. Промпт</strong><br><sub>Скопировать целиком</sub></td>
    <td align="center" width="20%">🏗️<br><strong>3. Реализация</strong><br><sub>Дождаться сборок</sub></td>
    <td align="center" width="20%">🔎<br><strong>4. Проверка</strong><br><sub>Вставить второй промпт</sub></td>
    <td align="center" width="20%">✅<br><strong>5. Результат</strong><br><sub>Отчёт и PASS</sub></td>
  </tr>
</table>
