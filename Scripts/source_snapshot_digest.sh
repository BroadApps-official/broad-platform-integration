...
/usr/bin/ruby -rdigest -e '
  ...
  patterns = [
    ...
    ".github/**/*",
    "Sources/**/*",
    "Examples/BroadAppleOnlyTemplate/Sources/**/*",
    "Examples/BroadAppleOnlyTemplate/project.yml",
    "Examples/BroadAppleOnlyTemplate/README.md",
    "Examples/BroadAppleOnlyTemplate/BroadAppleOnlyTemplate.xcodeproj/project.xcworkspace/xcshareddata/swiftpm/Package.resolved",
    ...
    "Examples/BroadAppTemplate/Configuration/AccountIntegration.json",
    "Examples/BroadAppTemplate/Scripts/**/*",
